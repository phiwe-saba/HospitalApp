...
namespace HospitalAppDAL.Migrations
{
    ...
    [Migration("20220318221508_AddToAddress")]
            ...
            modelBuilder.Entity("HospitalAppCore.Entites.Patient", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            PatientID = 1,
                            DOB = new DateTime(2022, 3, 19, 0, 14, 58, 186, DateTimeKind.Local).AddTicks(8626),
                            EmailAddress = "charmaine@gmail.com",
                            FullNames = "Charmaine Meintjies",
                            Gender = "Female",
